...
internal static partial class Program
{
    ...
    {
        // Find the csproj file in the current directory. Exclude autogenerated (Build.*.csproj) files.
        ...
        // Remove the autogenerated files from the csproj file
        if (args[0] == "--post")
        {
            Task.Delay(500).Wait();
        ...
        if (args[0] != "--pre")
        {
            Console.WriteLine("Invalid argument. Use --pre or --post.");
            return;
        }
